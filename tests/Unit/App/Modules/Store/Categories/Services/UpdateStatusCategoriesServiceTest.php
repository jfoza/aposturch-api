...
use App\Modules\Store\Categories\Services\UpdateStatusCategoriesService;
...
class UpdateStatusCategoriesServiceTest extends TestCase
{
    ...
    public function getUpdateStatusCategoryService(): UpdateStatusCategoriesService
    {
        return new UpdateStatusCategoriesService(
