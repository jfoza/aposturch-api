...
enum RulesEnum: string
{
    ...
    case MEMBERS_MODULE_CHURCH_DELETE = 'MEMBERS_MODULE_CHURCH_DELETE';
    case MEMBERS_MODULE_CHURCH_USER_RELATIONSHIP_DELETE = 'MEMBERS_MODULE_CHURCH_USER_RELATIONSHIP_DELETE';
    case MEMBERS_MODULE_CHURCH_IMAGE_UPLOAD = 'MEMBERS_MODULE_CHURCH_IMAGE_UPLOAD';
}
