...
enum RulesEnum: string
{
    ...
    case ADMIN_USERS_ADMIN_DEPARTMENT_VIEW   = 'ADMIN_USERS_ADMIN_DEPARTMENT_VIEW';
    case ADMIN_USERS_ADMIN_DEPARTMENT_INSERT = 'ADMIN_USERS_ADMIN_DEPARTMENT_INSERT';
    case ADMIN_USERS_ADMIN_DEPARTMENT_UPDATE = 'ADMIN_USERS_ADMIN_DEPARTMENT_UPDATE';
    case ADMIN_USERS_ADMIN_DEPARTMENT_DELETE = 'ADMIN_USERS_ADMIN_DEPARTMENT_DELETE';
    ...
    case PROFILES_ADMIN_DEPARTMENT_VIEW = 'PROFILES_ADMIN_DEPARTMENT_VIEW';
    ...
    case COUNT_USERS_ADMIN_DEPARTMENT_VIEW = 'COUNT_USERS_ADMIN_DEPARTMENT_VIEW';
