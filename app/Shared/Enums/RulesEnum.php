...
enum RulesEnum: string
{
    ...
    case MEMBERSHIP_MODULE_CHURCH_ADMIN_MASTER_MEMBER_RELATIONSHIP_DELETE = 'MEMBERSHIP_MODULE_CHURCH_ADMIN_MASTER_MEMBER_RELATIONSHIP_DELETE';
    case MEMBERSHIP_MODULE_CHURCH_ADMIN_CHURCH_MEMBER_RELATIONSHIP_DELETE = 'MEMBERSHIP_MODULE_CHURCH_ADMIN_CHURCH_MEMBER_RELATIONSHIP_DELETE';
}
